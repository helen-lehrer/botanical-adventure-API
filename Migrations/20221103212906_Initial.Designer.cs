...
namespace BotanicalAdventure.Migrations
{
    ...
    [Migration("20221103212906_Initial")]
            ...
            modelBuilder.Entity("BotanicalAdventure.Models.Item", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ItemId = 1,
                            CatPicture = "~/css/assets/img/forest_mushroom_3_cauliflower.jpg",
                            Category = "Forest",
                            ...
                            Picture = "https://drive.google.com/file/d/1OO4mIo_OmwYNJzcwYTcYcYjHetI_yVBP/preview",
                            Score = 100,
                        ...
                        {
                            ItemId = 2,
                            CatPicture = "~/css/assets/img/forest_mushroom_1_amanita.jpg",
                            Category = "Forest",
                            ...
                            Name = "Fly Amanita",
                            Picture = "https://drive.google.com/file/d/1A0oevkGY-IK7YuTt1bqD6Z2wet2NLD44/preview",
                            Score = 25,
                        ...
                        {
                            ItemId = 3,
                            CatPicture = "~/css/assets/img/forest_mushroom_2_chanterelle.jpg",
                            Category = "Forest",
                            ...
                            Name = "Chanterelle",
                            Picture = "https://drive.google.com/file/d/1fSI1HEVfaUbpJk_z7ZJv1Qp4Df8LuF9O/preview",
                            Score = 50,
                        ...
                        {
                            ItemId = 4,
                            CatPicture = "~/css/assets/img/forest_mushroom_2_lobster.jpg",
                            Category = "Coast",
                            ...
                            Picture = "https://drive.google.com/file/d/1IOMraKq3BamHzIje9p90hXq6ndntwaU2/preview",
                            Score = 50,
                        ...
                        {
                            ItemId = 5,
                            CatPicture = "~/css/assets/img/forest_flower_1_salmonberry.jpg",
                            Category = "Forest",
                            ...
                            Name = "Salmon Berry",
                            Picture = "https://drive.google.com/file/d/18yqjm8OtCCXzD213zck_Vzdt2HUkbEcZ/preview",
                            Score = 25,
                            Smell = "",
                            Symbolism = "Holiness",
                            Taste = "Bland",
                        ...
                        {
                            ItemId = 6,
                            CatPicture = "~/css/assets/img/forest_flower_2_bleedingheart.jpg",
                            Category = "Forest",
                            ...
                            Name = "Bleeding Heart",
                            Picture = "https://drive.google.com/file/d/1byzrsYDAPSDtoqdTYRE1Oue1XhZwnEOs/preview",
                            Score = 50,
                            Smell = "",
                        ...
                        {
                            ItemId = 7,
                            CatPicture = "~/css/assets/img/forest_flower_2_orangehoneysuckle.jpg",
                            Category = "Forest",
                            ...
                            Picture = "https://drive.google.com/file/d/1i1eyjLjAO-rAc6oG9pKVsBiIucndYOOY/preview",
                            Score = 50,
                            Smell = "Ravioli",
                        ...
                        {
                            ItemId = 8,
                            CatPicture = "~/css/assets/img/forest_flower_3_calypsoorchid.jpg",
                            Category = "Forest",
                            ...
                            Name = "Calypso Orchid",
                            Picture = "https://drive.google.com/file/d/1Ij4BIO8LeYLoZiHKxHn4PkokiISqG9Q3/preview",
                            Score = 100,
                            Smell = "Ravioli",
                            Symbolism = "Love, divination, luck",
                            Taste = "",
                        ...
                        {
                            ItemId = 9,
                            CatPicture = "~/css/assets/img/forest_flower_1_columbianmonkshood.jpg",
                            Category = "Forest",
                            ...
                            Picture = "https://drive.google.com/file/d/1r-LdtTz5I5Dn2dKYqS-mu07KY2sJVVk8/preview",
                            Score = 25,
                            Smell = "Ravioli",
                        ...
                        {
                            ItemId = 28,
                            CatPicture = "~/css/assets/img/forest_flower_3_huckleberry.jpg",
                            Category = "Forest",
                            ...
                            Name = "Huckle Berry",
                            Picture = "https://drive.google.com/file/d/1qfygAZ0nz8UswaQW-30WXoXfbeQBFR1R/preview",
                            Score = 100,
                            Smell = "Ravioli",
                            Symbolism = "",
                        ...
                        {
                            ItemId = 10,
                            CatPicture = "~/css/assets/img/coast_flower_1_common-yarrow.jpg",
                            Category = "Coast",
                            ...
                            Name = "Common yarrow",
                            Picture = "https://drive.google.com/file/d/1VdQdvAu2vDOnRmYKkvcw47f3yh-SZfWG/preview",
                            Score = 10,
                        ...
                        {
                            ItemId = 11,
                            CatPicture = "~/css/assets/img/coast_flower_2_pearly-everlasting.jpg",
                            Category = "Coast",
                            ...
                            Picture = "https://drive.google.com/file/d/12TWxGANeYY6AeRVCwOShoHX6cwuZ8cgY/preview",
                            Score = 30,
                            Smell = "",
                            Symbolism = "",
                            Taste = "",
                        ...
                        {
                            ItemId = 12,
                            CatPicture = "~/css/assets/img/coast_flower_3_foxglove.jpg",
                            Category = "Coast",
                            ...
                            Name = "Foxglove",
                            Picture = "https://drive.google.com/file/d/1sMxsSXy7rBKpLDy9VGtSJL6w04wRUm3q/preview",
                            Score = 60,
                            Smell = "",
                            Symbolism = "",
                            Taste = "",
                        ...
                        {
                            ItemId = 13,
                            CatPicture = "~/css/assets/img/Desert_flower_1_Goldfields.jpg",
                            Category = "Desert",
                            ...
                            Name = "Goldfields",
                            Picture = "https://drive.google.com/file/d/1aa8_ztBf1MVV7liGyCsLD3-bOXSf5EES/preview",
                            Score = 15,
                            Smell = "",
                            Symbolism = "",
                            Taste = "",
                        ...
                        {
                            ItemId = 14,
                            CatPicture = "~/css/assets/img/desert_flower_1_prairiestar.jpg",
                            Category = "Desert",
                            ...
                            Name = "Prairie Star",
                            Picture = "https://drive.google.com/file/d/1gxhxYjvQE9hJpjTpmVlELmqoNFTRTf7F/preview",
                            Score = 20,
                            Smell = "fragrant",
                            Symbolism = "",
                            Taste = "",
                        ...
                        {
                            ItemId = 15,
                            CatPicture = "~/css/assets/img/desert_flower_1_spreadingphlox.jpg",
                            Category = "Desert",
                            ...
                            Picture = "https://drive.google.com/file/d/1PT_5RCOoy7mps2HhD99oYgMjkar5BsoI/preview",
                            Score = 25,
                            Smell = "fragrant",
                            Symbolism = "",
                            Taste = "",
                        ...
                        {
                            ItemId = 16,
                            CatPicture = "~/css/assets/img/desert_flower_2_sandlily.jpg",
                            Category = "Desert",
                            Description = "Sand lilies can often look like bunches of tissue paper dotting your preview. It grows in rosette-like bunches with 4-8 white flowers per bunch.",
                            Difficulty = "medium",
                            Edible = false,
                            EdibleDesc = "",
                            Found = false,
                            Habitat = "sandy or rocky areas",
                            Hint = "Blooms and leaves might be nipped off, as it is a favorite snack of rabbits and deers!",
                            History = "",
                            Latin = "Leucocrinum monatanum",
                            Name = "Sand Lily",
                            Picture = "https://drive.google.com/file/d/1rx7_fJIpsvvo2gD8RwMTa36C-w9QOe1C/preview",
                            Score = 50,
                            Smell = "fragrant",
                            Symbolism = "",
                            Taste = "",
                        ...
                        {
                            ItemId = 17,
                            CatPicture = "~/css/assets/img/desert_flower_2_spottedfritillary.jpg",
                            Category = "Desert",
                            ...
                            Picture = "https://drive.google.com/file/d/1dQFmOnA0KWRk7Rf_WnjCUL59AvAnCsO9/preview",
                            Score = 65,
                            Smell = "",
                            Symbolism = "",
                            Taste = "",
                        ...
                        {
                            ItemId = 18,
                            CatPicture = "~/css/assets/img/desert_flower_2_brownspeony.jpg",
                            Category = "Desert",
                            ...
                            Name = "Brown’s peony",
                            Picture = "https://drive.google.com/file/d/1Pf803UlHtIhJNpndF1gp80xpC0nCQtsx/preview",
                            Score = 75,
                            Smell = "",
                            Symbolism = "",
                            Taste = "",
                        ...
                        {
                            ItemId = 19,
                            CatPicture = "~/css/assets/img/desert_flower_3_bradshawsdesertparsley.jpg",
                            Category = "Desert",
                            ...
                            Picture = "https://drive.google.com/file/d/1bFSo52XFR5LNsziUPKDtg1QEe1wlVMFh/preview",
                            Score = 100,
                            Smell = "",
                            Symbolism = "",
                            Taste = "",
                        ...
                        {
                            ItemId = 20,
                            CatPicture = "~/css/assets/img/desert_flower_3_prairiesmoke.jpg",
                            Category = "Desert",
                            ...
                            Name = "Prairie smoke",
                            Picture = "https://drive.google.com/file/d/1VrIF9gpSJ2osLRB_CYlbBMzaJVsyghLT/preview",
                            Score = 85,
                            Smell = "",
                        ...
                        {
                            ItemId = 21,
                            CatPicture = "~/css/assets/img/desert_flower_3_raggedrobin.jpg",
                            Category = "Desert",
                            ...
                            Name = "Ragged robin",
                            Picture = "https://drive.google.com/file/d/14LyVI8S7_N0Z9gP_nj8RduDEh-0EAyFd/preview",
                            Score = 85,
                            Smell = "",
                            Symbolism = "",
                            Taste = "",
                        ...
                        {
                            ItemId = 22,
                            CatPicture = "~/css/assets/img/desert_tree_1_grayrabbitbrush.jpg",
                            Category = "Desert",
                            ...
                            Picture = "https://drive.google.com/file/d/1Hp762UZlyyI5PQXXzYuqkpTt0g-L00MX/preview",
                            Score = 25,
                        ...
                        new
                        {
                            ...
                            Name = "Big Sagebrush",
                            Picture = "https://drive.google.com/file/d/1FY1ZEoyuauLY9rLeIlGcdkjh7f0Qe6jX/preview",
                            Score = 15,
                        ...
                        new
                        {
                            ...
                            Name = "Ponderosa Pine",
                            Picture = "https://drive.google.com/file/d/1Z8Z5oLQ3cD_jojTKAGzB6dU1qPYGKM0Q/preview",
                            Score = 15,
                            Smell = "pine",
                        ...
                        {
                            ItemId = 25,
                            CatPicture = "~/css/assets/img/desert_tree_2_westernjunipers.jpg",
                            Category = "Desert",
                            ...
                            Picture = "https://drive.google.com/file/d/1KSjwABcihhk2rEYIPcjpEpdtIPmWUAGl/preview",
                            Score = 60,
                            Smell = "",
                        ...
                        {
                            ItemId = 26,
                            CatPicture = "~/css/assets/img/desert_tree_2_snowbrush.jpg",
                            Category = "Desert",
                            ...
                            Name = "Snowbrush",
                            Picture = "https://drive.google.com/file/d/1_Xi_Q9kyXRUhmiJsgoKr4CfdzKzIYxwL/preview",
                            Score = 45,
                        ...
                        {
                            ItemId = 27,
                            CatPicture = "~/css/assets/img/desert_tree_3_grandfir.jpg",
                            Category = "Desert",
                            ...
                            Latin = "Abies grandis",
                            Name = "Grand Fir",
                            Picture = "https://drive.google.com/file/d/1eWZ5ob6-TdCN8Y8mVG3iTL9GfeNSqdEH/preview",
                            Score = 65,
                            Smell = "pine scent",
                        ...
                        {
                            ItemId = 33,
                            CatPicture = "~/css/assets/img/coastal_tree_1_douglasfir.jpg",
                            Category = "Coastal",
                            Description = "Douglas-firs are medium-size to extremely large evergreen trees. The leaves are flat, soft, linear needles, generally resembling those of the firs, occurring singly rather than in fascicles; they completely encircle the branches, which can be useful in recognizing the species.",
                            Difficulty = "Easy",
                            Edible = true,
                            EdibleDesc = "Douglas fir spring tips are edible and are high in Vitamin C and electrolytes. You can eat them fresh, freeze them, or dry them. Both hot tea and sun tea are tasty.",
                            Found = false,
                            Habitat = "Grows in wet, coastal and inland areas",
                            Hint = "These tree's cones have 3-forked bracts sticking out from the scales. These look like the tails and hind feet of mice hiding in the cone",
                            History = "Native Americans used Douglas-fir wood for fuel, small utensils, and tools; they used its pitch for sealing joints and caulking canoes and water containers. They also used the tree and its parts for a variety of medicinal purposes.",
                            Latin = "Pseudotsuga menziesii",
                            Name = "Douglas Fir",
                            Picture = "https://drive.google.com/file/d/1w1ghq5g0uq91rFUVnH9C6Yq1UKNl0soy/preview",
                            Score = 25,
                            Smell = "Strong, sweet, clean, piney-fresh scent with citrusy notes",
                            Symbolism = "The symbolism of a fir tree carries the message of hope during challenges and encourages you to have patience while you wait for a better future.",
                            Taste = "Meyer lemon peel or tangerine peel. Another might taste like peach skin, and then another may be a sharp resiny green flavor",
                            Type = "Tree"
                        },
                        new
                        {
                            ItemId = 29,
                            Category = "Forest",
                            Description = "Bigleaf maple can grow up to 48 metres (158 feet) tall, but more commonly reaches 15-20 m (50-65 ft) tall. The bigleaf maple has the largest leaves of any maple,  ",
                            Difficulty = "Easy",
                            Edible = true,
                            EdibleDesc = "Big Leaf maple has the sweetest sap of all the native northwest maples, However because the sugar content is quite low, you'll need to gather a lot more to produce the same amount of sweet syrup as the sugar mapleThose gorgeous clusters are also delicious for us to eat, especially when they're young and tender.",
                            Found = false,
                            Habitat = "",
                            Hint = "It usually dangles unusually large, 5-lobed, palmate (palm-shaped) leaves from its branches.",
                            History = "Some of its leaves grow so big Native Americans used them as containers and plates. They also called the Big leaf maple the “paddle tree” because its wood makes excellent canoe paddles.",
                            Latin = "Acer macrophyllum",
                            Name = "Big Leaf Maple",
                            Picture = "https://drive.google.com/file/d/1w1ghq5g0uq91rFUVnH9C6Yq1UKNl0soy/preview",
                            Score = 25,
                            Smell = "Fragrant greenish-yellow flowers bloom in April-May",
                            Symbolism = "Maple is a symbol of strength and endurance",
                            Taste = "Those gorgeous clusters are also delicious for us to eat, especially when they're young and tender.",
                            Type = "Tree"
                        },
                        new
                        {
                            ItemId = 31,
                            CatPicture = "~/css/assets/img/.jpg",
                            Category = "Coast",
                            Description = "A small evergreen conifer (sometimes appearing as a shrub), the Pacific yew grows to 10-15 m (33-49 ft) tall, It has thin, scaly bark, red then purplish-brown,covering a thin layer of off-white sap wood with a darker heartwood that varies in color from brown to a purplish hue to deep red, or even bright orange when freshly cut.The leaves are lanceolate, flat, and dark green. ",
                            Difficulty = "easy",
                            Edible = true,
                            EdibleDesc = "While many parts of yews are poisonous and can be fatal if eaten, the juicy red cup around the seed seems to be edible as long as the seed within is not chewed or swallowed",
                            Found = false,
                            Habitat = "Dry interior forests, the species develops best along mountain streams, and in shady canyons, ravines, and coves. Within the moist maritime climate of the Pacific Northwest, it grows most abundantly in drier, warmer environments.",
                            Hint = "It grows in varying types of environments; however, in drier environments it is mostly limited to stream-side habitats, whereas in moist environments it will grow up onto slopes and ridgetops",
                            History = "Traditionally, the resilient and rot-resistant wood was used by Native Americans to make tools, bows (backed with sinew), arrows, and canoe paddles.[4] Other purposes for yew included making harpoons, fishhooks, wedges, clubs, spoons, drums, snowshoes, and arrowheads.[4] The foliage and bark was used for medicinal purposes.",
                            Latin = "Taxus brevifolia",
                            Name = "Pacific Yew",
                            Picture = "https://drive.google.com/file/d/1org_4v5kJo6_cJcBZHQsDitcMCedZuTL/preview",
                            Score = 10,
                            Smell = "Odorless",
                            Symbolism = "",
                            Taste = "cherry jello-like taste",
                            Type = "Tree"
                        });
                });
